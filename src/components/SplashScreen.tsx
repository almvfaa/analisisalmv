...
export const SplashScreen: React.FC<SplashScreenProps> = ({ onStart }) => {
  return (
    <>
      <Helmet>
        <title>Almacén de Víveres</title>
      </Helmet>
      <div className="relative flex flex-col items-center justify-center min-h-screen bg-gray-50 text-gray-800 p-4 sm:p-8 overflow-hidden">
        ...
        <div className="w-full max-w-5xl text-center z-10">
          ...
          <div className="mb-12 animate-float">
            <img src="https://fundacionhcgdl.org/wp-content/uploads/HospitalCivilGdl.png" alt="Logo Hospital Civil de Guadalajara" className="mx-auto h-48 object-contain" />
          </div>

          <div className="mb-12 fade-in-up delay-200ms">
            <div className="mt-6 text-lg md:text-2xl text-blue-600 font-semibold flex flex-col md:flex-row items-center justify-center gap-x-4">
              <span>Almacén de Víveres</span>
              <span className="text-gray-400 font-light text-sm hidden md:inline-block">Y</span>
              <span>Coordinación General Jurídica</span>
            </div>
          </div>
